...
class BackboneVPTV2(nn.Module):
    def __init__(self, args, foundation, mode='rgbd'):
        super(BackboneVPTV2, self).__init__()
        self.args = args
        self.mode = mode
        ...
        self.former = PVTVPTV2(in_chans=64, patch_size=2, pretrained='./model/completionformer_original/pretrained/pvt.pth', foundation=foundation.former)
