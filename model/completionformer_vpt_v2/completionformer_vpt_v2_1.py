...
from .backbone_vpt_v2_1 import BackboneVPTV2_1

class CompletionFormerVPTV2_1(nn.Module):
    def __init__(self, args):
        super(CompletionFormerVPTV2_1, self).__init__()
        ...
        self.backbone = BackboneVPTV2_1(args, self.foundation.backbone, mode='rgbd')
